...
export default function CreateListing() {
    ...
    // Handling the change for our inputs 
    const changeHandler = (e) => {
        ...
        if (e.target.id === "parking" || e.target.id === "furnished" || e.target.id === "offer") {
            setFormData({
                ...formData,
                [e.target.id]: e.target.checked,  //e.target.id can be furnished or parking or offer
            })
        }
        // condition 3
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discountPrice) return setError("Regular price must be bigger than discounted price")
            setLoading(true)
            setError(false)
